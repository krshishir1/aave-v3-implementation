...
contract Liquidate {
    ...
    function liquidate(
        ...
        console.log(stableDebt, variableDebt);
        ...
        IERC20(borrowedToken).approve(address(pool), totalDebt);

        // Task 1.4 - Call liquidate
        pool.liquidationCall(collateral, borrowedToken, user, totalDebt, false);
    }
}
